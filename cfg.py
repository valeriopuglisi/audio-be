...
SPEAKER_VERIFICATION_DATASET = os.path.join(os.getcwd(), "speaker_verification_dataset")
...
pathlib.Path(SPEAKER_VERIFICATION_DATASET).mkdir(parents=True, exist_ok=True)
# print(MEDIA_DIR)
