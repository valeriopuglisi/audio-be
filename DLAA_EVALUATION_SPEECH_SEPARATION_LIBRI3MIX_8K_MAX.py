...
def speech_separation_evaluate_metric_with_model_on_libri3mix(model, dataset, metrics, n_test, mix_type="test_mix_clean_file"):
    ...
    for i, row in enumerate(test_table.iterrows()):
        ...
        if model_sample_rate != dataset_sample_rate:
            ...
            mixture_path =  "libri3mix_8k_max_evaluation_target_mixture.wav"
            source_1_path = "libri3mix_8k_max_evaluation_target_source_1.wav"
            source_2_path = "libri3mix_8k_max_evaluation_target_source_2.wav"
            source_3_path = "libri3mix_8k_max_evaluation_target_source_3.wav"
